...
public class FastCash extends JFrame implements ActionListener{
    ...
    JButton amount1, amount2, amount3, amount4, back, amount5, amount6;
    String pinnumber;
    ...
    FastCash(String pinnumber){
        ...
        amount1.setFont(new Font("System", Font.BOLD, 14));
        image.add(amount1);
        
        amount2 = new JButton("Rs 500");
        amount2.setBounds(360, 415, 150, 30);
        amount2.setFont(new Font("System", Font.BOLD, 14));
        amount2.addActionListener(this);
        image.add(amount2);
        
        amount3 = new JButton("Rs 1000");
        amount3.setBounds(160, 450, 150, 30);
        amount3.setFont(new Font("System", Font.BOLD, 14));
        amount3.addActionListener(this);
        image.add(amount3);
        
        amount4 = new JButton("Rs 2000");
        amount4.setBounds(360, 450, 150, 30);
        amount4.setFont(new Font("System", Font.BOLD, 14));
        amount4.addActionListener(this);
        image.add(amount4);
        
        amount5 = new JButton("Rs 5000");
        amount5.setBounds(160, 485, 150, 30);
        amount5.setFont(new Font("System", Font.BOLD, 14));
        amount5.addActionListener(this);
        image.add(amount5);
        
        amount6 = new JButton("Rs 10000");
        amount6.setBounds(360, 485, 150, 30);
        amount6.setFont(new Font("System", Font.BOLD, 14));
